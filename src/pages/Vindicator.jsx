...
export default function Vindicator() {
    const skillText = {
        "" : "Vinh the Vindicator. The Frontend of Vinh's Vanguard. As the leader of the operation, Vindicator plans and visualizes his victory through the mastery of HTML, CSS, JS, and React.",
        ...
        "react": "Empowers Vindicator to protect his allies with lightning-fast responses and unmatched adaptability. Dynamically adjusts his tactics to counter any adversary."        
    };
