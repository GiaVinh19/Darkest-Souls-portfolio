...
export default function Venator({}) {
    const skillText = {
        "" : "Vinh the Venator. The Generalist of Vinh's Vanguard. As the artisan of all trades, Venator adapts to various challenges of visual, audio and game design by his versatility in Audacity, Godot, Krita, and Capcut.",
